...
function loadScript(src,onload){const s=document.createElement('script');s.src=src;s.onload=onload;document.body.appendChild(s);}loadScript('character-engine-options-v2.js',()=>loadScript('character-engine-class-sync-v3.js',()=>loadScript('character-sheet-v2.js')));
})();
