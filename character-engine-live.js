...
(() => {
    ...
    function loadScript(src,onload){const script=document.createElement('script');script.src=src;script.onload=onload;document.body.appendChild(script);}
    loadScript('character-engine-options-v2.js',()=>loadScript('character-sheet.js'));
})();
