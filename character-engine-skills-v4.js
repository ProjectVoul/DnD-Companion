...
(() => {
  ...
  // PHB 2014 class skill choices. The Paladin entry is verified directly
  // against the uploaded Player's Handbook (Paladino: two choices).
  ...
  function getSelectedClassSkills(character) {
    ...
    const selected = character.choices.classSkills.filter(s => data.options.includes(s));
