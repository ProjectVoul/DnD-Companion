...
export const ALL_SPELLS=uniqueById([...SPELLS,...PALADIN_SPELLS,...PALADIN_SUPPLEMENTAL_SPELLS,...SUBCLASS_CANONICAL_SPELLS,...SUBCLASS_CANONICAL_SPELLS_EXTRA,...XANATHAR_CANONICAL,...XANATHAR_SPELLS_EXTRA,...TASHA_SPELLS]);
