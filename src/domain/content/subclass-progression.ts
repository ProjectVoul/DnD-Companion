...
/** Universal 2014 subclass progression. Actual feature records remain separate data. */
const FEATURE_LEVELS:Record<string,number[]>={barbarian:[3,6,10,14],bard:[3,6,14],cleric:[1,2,6,8,17],druid:[2,6,10,14],fighter:[3,7,10,15,18],monk:[3,6,11,17],paladin:[3,7,15,20],ranger:[3,7,11,15],rogue:[3,9,13,17],sorcerer:[1,6,14,18],warlock:[1,6,10,14],wizard:[2,6,10,14],artificer:[3,5,9,15]};
...
export const subclassFeaturePlaceholders=(classId:string,subclassId:string):Feature[]=>subclassFeatureSlots(classId,subclassId).map(slot=>({id:slot.id,name:slot.name,source:'subclass',level:slot.level}));
