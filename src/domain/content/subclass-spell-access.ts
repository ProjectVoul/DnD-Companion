...
/** Structured subclass spell access. Spell IDs always reference the canonical spell catalog. */
export interface SubclassSpellAccess {
  classId:string;
  subclassId:string;
...
export function subclassSpellAccess(classId:string,subclassId?:string):SubclassSpellAccess|undefined{return subclassId?SUBCLASS_SPELL_ACCESS.find(x=>x.classId===classId&&x.subclassId===subclassId):undefined;}
