...
export interface FeatureDefinition extends Omit<Feature,'effects'>{sourceBook:'phb2014'|'xge2017'|'tasha2020'|'homebrew';classId?:string;subclassId?:string;prerequisiteLevel?:number;effects?:FeatureEffect[];choiceGroup?:string;}
