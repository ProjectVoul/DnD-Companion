...
const base:Character={id:'multiclass-test',name:'Test',species:'Human',classes:[{id:'fighter',name:'Fighter',level:4}],level:4,abilityScores:{str:16,dex:10,con:14,int:10,wis:10,cha:10},skillStates:{} as Character['skillStates'],savingThrowProficiency:[],proficiencyBonus:2,maxHP:36,currentHP:36,tempHP:0,hitDice:{die:10,max:4,current:4},deathSaves:{successes:0,failures:0},items:[],spellcasting:{},features:[],resources:[],conditions:[],resistances:[],contentSources:['phb2014','tasha2020','homebrew']};
