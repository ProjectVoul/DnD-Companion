...
export function passiveInvestigation(c:Character){return 10+skillBonus(c,'investigation')+effectBonus(c,'passiveInvestigation')}
export function speed(c:Character){return (c.speed??30)+effectBonus(c,'speed')}
